...
| ADM-44 | [后端] 修复 OpenAPI /cms/v1/regions/list 地域字典缺失86个地级市（ADM-43子任务） | 开发中 | Loop adm-pm助手专家 | 2026-09-07 09:53 | 提需人：胡映昕（继承父需求ADM-43）；父需求ADM-43；9/4 17:05 状态变更 todo→in_progress + 指派人变更（4f356f9a→d0ff2b22）；已通知群聊@胡映昕；9/4 17:24 指派人变更（41eee17b→4f356f9a）；已通知群聊@胡映昕；9/4 17:34 updated（当前in_progress）；已通知群聊@胡映昕；9/7 09:53 状态变更 blocked→in_progress；9/9 09:58 指派人变更（4f356f9a→02c8a8d1）；9/9 10:05 指派人变更（02c8a8d1→41eee17b）；9/9 10:05 新评论（mysql查询结果：st_region按regionFileName分组统计stid数量）；已通知群聊@胡映昕 |
