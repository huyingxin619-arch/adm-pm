...
| ADM-44 | [后端] 修复 OpenAPI /cms/v1/regions/list 地域字典缺失86个地级市（ADM-43子任务） | 开发中 | Loop adm-pm助手专家 | 2026-09-04 17:24 | 提需人：胡映昕（继承父需求ADM-43）；父需求ADM-43；9/4 17:05 状态变更 todo→in_progress + 指派人变更（4f356f9a→d0ff2b22）；已通知群聊@胡映昕；9/4 17:24 指派人变更（41eee17b→4f356f9a）；已通知群聊@胡映昕 |
