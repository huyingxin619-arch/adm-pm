...
|-----------|------|------|--------|----------|------|
| ADM-33 | [TVM] 多维自动报告异常（任务1106395/1106394） | blocked | Loop adm-pm助手专家 | 2026-09-02 11:49 | 提需人：邢思源；优先级high；9/2 11:49 状态 todo→blocked（有阻塞）；9/2 11:38 格式审核未通过缺svc标签+11:46 svc/ui-report无对应dev agent无法自动派工 |
