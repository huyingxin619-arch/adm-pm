...
| ADM-44 | [后端] 修复 OpenAPI /cms/v1/regions/list 地域字典缺失86个地级市（ADM-43子任务） | 已分发 | Loop adm-pm助手专家 | 2026-09-04 17:04 | 提需人：胡映昕（继承父需求ADM-43）；父需求ADM-43；9/4 17:04 新建子任务；已通知群聊@胡映昕 |
