...
| ADM-44 | [后端] 修复 OpenAPI /cms/v1/regions/list 地域字典缺失86个地级市（ADM-43子任务） | 开发中 | Loop adm-pm助手专家 | 2026-09-04 17:34 | 提需人：胡映昕（继承父需求ADM-43）；父需求ADM-43；9/4 17:05 状态变更 todo→in_progress + 指派人变更（4f356f9a→d0ff2b22）；已通知群聊@胡映昕；9/4 17:24 指派人变更（41eee17b→4f356f9a）；已通知群聊@胡映昕；9/4 17:34 updated（当前in_progress）；已通知群聊@胡映昕 |
| ADM-45 | [TVM] PMO跨屏打通任务18195状态卡在'提交成功'，无计算进程 | 开发中 | Loop adm-pm助手专家 | 2026-09-04 17:40 | 提需人：吴济；优先级high；issue ID: 1f7d3e60-272f-44de-bd01-165ba580f32b；9/4 17:40 状态变更 todo→in_progress；已通知群聊@吴济 |
| ADM-46 | [TVM] 排查PMO跨屏打通任务18195卡在'提交成功'状态（ADM-45子任务） | 开发中 | Loop adm-pm助手专家 | 2026-09-04 19:03 | 提需人：吴济（继承父需求ADM-45）；父需求ADM-45；9/4 19:03 新评论（PMO跨屏打通任务18195状态机代码分析报告）；已通知群聊@吴济 |
